...
{
    // get the application path for use here, the const will not work as it has not been defined here
    $appPath = dirname($_SERVER['DOCUMENT_ROOT']);
    require_once('Zend/Auth.php');
    require_once('Zend/Acl.php');
    require_once($appPath . '/application/modules/user/acl/Role/Guest.php');
    require_once($appPath . '/application/modules/user/acl/Role/User.php');
    require_once($appPath . '/application/modules/user/acl/Role/Mod.php');
    require_once($appPath . '/application/modules/user/acl/Role/Admin.php');
    require_once($appPath . '/application/modules/pages/acl/Assert/PageAccess.php');
    require_once($appPath . '/application/modules/user/acl/Acl.php');
